...
/**
 * Classe que define uma Atividade de estágio no sistema (com base na classe Atividade).
 * 
...
public class AtividadeEstagio extends Atividade {
	 ...
	 */
	private final int UNIDADEMIN = 300;
	 ...
	 */
	public AtividadeEstagio(String id, String tipo, int unidadeAcumulada, String disciplina) throws IllegalArgumentException{
		super(id, tipo);
	...
	protected double calculaCreditos() {
		double valor = (unidadeAcumulada * 1) / 60;
